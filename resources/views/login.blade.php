...
<body class="w-screen h-screen flex justify-center items-center bg-gradient-to-b from-[#06402b] to-white">
    <div class="h-[60%] w-[80%] md:w-[60%] lg:w-[30%] border border-white bg-white/20 rounded-3xl shadow-md flex flex-col justify-center items-center gap-y-5">
        <div class="flex flex-col justify-center items-center gap-y-1">
            <span class="uppercase text-white font-extrabold text-3xl">ADMIN</span>
        ...
        <div class="relative flex items-center w-[70%] justify-center">
            ...
            <input type="text" class="w-full h-10 px-9 border border-white focus:outline-none focus:ring-0 rounded-lg font-semibold" placeholder="Username">
        </div>
        <!-- Password Input -->
        <div class="relative flex items-center w-[70%] justify-center">
            <img src="{{ asset('password.png') }}" alt="" class="absolute left-3 size-4">
            <input type="password" class="w-full h-10 px-9 border border-white focus:outline-none focus:ring-0 rounded-lg font-semibold" placeholder="Password">
        </div>
