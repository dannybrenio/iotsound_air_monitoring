<x-layout>
    ...
    <script>
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    const cards = data.forecast.forecastday.map(day => {
                        ...
                        return `
                            <div class="flex flex-col justify-between items-center border-2 border-[#06402b] rounded-xl p-5 w-[70%] lg:w-44 text-center shadow-xl hover:scale-105 duration-300 ${highlight}">
                    ...
                    container.innerHTML = `
                        <div class="flex flex-col justify-center items-center mb-4">
                            <h2 class="text-xl lg:text-2xl font-bold text-[#06402b] uppercase">${location}</h2>
                            <p class="text-base lg:text-lg text-[#a8a8a8]">( Current: ${current} )</p>
                        </div>
        ...
        // Treshold Slider
        const aqi = 57; // change this dynamically if needed
