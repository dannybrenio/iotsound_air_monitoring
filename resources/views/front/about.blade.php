            ...
            <div
                ...
                <div class="flex flex-col w-full lg:w-[50%] h-[45%] lg:h-[80%] justify-between items-center">
                    <div
                        ...
                        <span class="text-black text-base md:text-xl lg:text-2xl whitespace-normal text-center">
                            We envision cleaner, safer, and quieter cities where technology and community awareness work
                ...
                <div class="flex flex-col w-[90%] h-[90%] lg:h-[80%] justify-center items-center">
                    <div
                        ...
                        <span class="text-[#06402b] font-extrabold text-2xl md:text-4xl lg:text-6xl uppercase">WHO
                            ...
                            <span
                                class="text-[#06402b] font-extrabold text-2xl md:text-4xl lg:text-6xl uppercase">SERVE</span>
                        </span>
                        <span class="text-black text-lg md:text-xl lg:text-2xl whitespace-normal text-center">
                            We are here for communities, schools, businesses, and local governments who share our vision
                            of sustainable and healthy living spaces. By providing accessible technology, we help people
                            make informed decisions that contribute to cleaner air, reduced noise, and improved quality
                            of life.
                        </span>
                        <span class="text-black text-lg md:text-xl lg:text-2xl whitespace-normal text-center">
                            At the core of what we do is a simple belief: everyone deserves a safe, healthy, and
        ...
        const observer = new IntersectionObserver(entries => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    // Fade out again when leaving view
