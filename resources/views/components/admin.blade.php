...
<body>
    ...
    <!-- Sidebar -->
    <div id="mobile-menu" class="bg-[#E0EBDC] fixed h-screen w-[65%] lg:w-[20%] flex flex-col justify-between items-center py-6 gap-y-5 
        ...
        <div
            class="w-[80%] h-30 flex flex-col justify-between items-center gap-y-2 flex-shrink-0 bg-[#FFFFFF] rounded-xl py-3">
            ...
            <a href="{{ route('logout') }}"
                class="px-2.5 text-[#FFFFFF] text-xs flex flex-row gap-x-1 bg-[#06402b] items-center font-semibold hover:text-[#06402b] hover:bg-[#a9b3da] w-[80%] h-8 rounded justify-center duration-300">
    ...
    <main class="lg:pl-[20%] pl-0">
        ...
        <div x-data="notifBell" class="fixed right-5 top-5">
            ...
            <div x-show="open" @click.outside="closeNotif()" x-transition
                ...
                <div id="notifList" class="max-h-120 overflow-y-auto p-3 space-y-2 sidebar-scroll">
